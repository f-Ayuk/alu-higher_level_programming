...
const arg = process.argv[2]; // get the first argument passed to the script, which is the third element in the process.argv array
const num = parseInt(arg); // try to convert the argument to an integer using the parseInt function
